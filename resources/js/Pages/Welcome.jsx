                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        ...
                        <main className="mt-6">
                            <section class="sm:bg-white md:bg-gray-50">
                                <div class=" py-2 md:py-8 px-2 md:mx-auto md:max-w-2xl lg:py-16  gap-8 lg:gap-16 flex flex-col justify-center items-center">
                                    <div class="flex flex-col justify-center">
                                        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-2xl lg:text-2xl">Laman Undi</h1>
                                        <p class="text-lg font-normal text-gray-500 lg:text-xl">Selamat datang ke Laman Undi!<br/> Sila masuk untuk mengundi pemenang </p><p class="font-semibold text-gray-900 text-2xl">Anugerah Paling Sporting, Menyenangkan & Serba Boleh</p>.
                                    ...
                                    <div class="w-full max-w-2xl md:p-6 md:space-y-8 sm:p-8 md:bg-white rounded-lg md:shadow-xl">
